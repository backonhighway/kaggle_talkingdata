...
MODEL_FILE = os.path.join(FINAL_DIR, "pocket_final_model_val_s54.csv")
PREDICTION = os.path.join(FINAL_DIR, "pocket_final_pred_val_s54.csv")
...
lgb = seeding_val_lgb.GoldenLgb(54)
