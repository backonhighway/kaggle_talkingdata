...
MODEL_FILE = os.path.join(FINAL_DIR, "pocket_final_model_test_s92.csv")
PREDICTION = os.path.join(FINAL_DIR, "pocket_final_pred_test_s92.csv")
...
lgb = seeding_test_lgb.GoldenLgb(92)
