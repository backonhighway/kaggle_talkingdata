...
PREDICTION = os.path.join(FINAL_DIR, "pocket_final_val_s99.csv")
...
train7 = pd.read_feather(LONG7).head(1000*1000)
train8 = pd.read_feather(LONG8).head(1000*1000)
train9 = pd.read_feather(LONG9).head(1000*1000)
